...
function AddUpdateResident(props) {
  return (
    ...
    <div class="card-body">
        <h3 class="card-title">fgfggf Block</h3>
        <p class="card-text">
        <strong>Apartment Type:</strong> fgbfgb <br/>
        <strong>Apartment No:</strong> gb.Floor <br/>
        <strong>Apartment Status:</strong> fgb  <br/>
        <strong>Resident:</strong> sdvsdvsd
        </p>
    </div>
    </div>
  );
